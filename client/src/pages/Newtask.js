...
const NewTask = () => {
  ...
  return (
    ...
    <div className="flex h-screen bg-gradient-to-br from-blue-400 to-indigo-600">
      ...
      {/* {showSuccessModal && (
            <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" id="my-modal">
              <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-green-100 text-green-700">
                <div className="mt-3 text-center">
                  <h3 className="text-lg leading-6 font-medium">Task Added Successfully</h3>
                  <div className="mt-2 px-7 py-3">
                    <p className="text-sm">
                      Your task has been added.
                    </p>
